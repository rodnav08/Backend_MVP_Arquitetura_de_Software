...
from flask import redirect, Flask, request, send_from_directory, render_template, make_response, send_file, Response
...
info = Info(title="API Dutos", version="1.0.0")
...
@app.post('/perfildev', tags=[tubo_tag])
def perfildev():
    """Utilizando uma API pública, exporta uma página web (URL) para um arquivo PDF.
    """
    url_to_pdf_api = "https://html2pdf-rocket.p.rapidapi.com/pdf"


    # Disponibilizando a url do meu perfil no GitHub
    payload = {
        "value": "https://github.com/rodnav08" 
    }

    headers = {
        "content-type": "application/json",
        "X-RapidAPI-Key": "62bd546d0cmsh88fdde80b1ab874p1f3b95jsnece1ba3afa35",
